            ...
            <div class="row  justify-content-center">
                <div class="col-md-8 grid-margin stretch-card">
                    <div class="card">
                        ...
                        <h2 class="card-title text-center text-info">New Category</h2>
                        <p class="card-description"></p>
                        <form class="" method="POST" action="{{ route('admin.category.store') }}" >
                        @csrf
                            <div class="form-group">
                                <label for="exampleInputName1">Category Name</label>
                                <input type="text" placeholder="Category Name" name="cat_name" class="form-control" id="cat_name" required>
                            </div> 
                            <div class="form-group">
                                <label for="exampleInputName1">Category Slug</label>
                                <input type="text" placeholder="Category Slug" name="cat_slug" class="form-control" id="cat_slug" required>
                            </div> 
